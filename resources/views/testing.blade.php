<x-layout>
    <x-slot:title>Detail Status Pesanan</x-slot:title>

    {{-- Wrapper utama dengan inisialisasi Alpine.js --}}
    <div class="max-w-4xl mx-auto px-4 py-8" x-data="orderStatus()">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="text-center p-4">
                    ...
                    <p class="text-gray-600">Ubah status di dalam &lt;script&gt; untuk melihat progress bar berubah.</p>
                </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <template x-for="item in order.items" :key="item.id">
                                    <div class="flex justify-between items-center py-2 border-b border-gray-200">
                                        ...
                                        <span class="font-medium" x-text="formatCurrency(item.quantity * item.price)"></span>
                                    </div>
                                </template>
                                {{-- Total Harga --}}
    ...
    <script>
        function orderStatus() {
            return {
                 // --- INI ADALAH DUMMY DATA ANDA ---
                order: {
                    id: 'ORD-DUMMY-001',
                    status: 'Sedang Diverifikasi', // Coba ganti ke 'Sudah Diverifikasi' atau 'Selesai'
                    orderDate: '25 Juni 2025',
                    paymentMethod: 'Transfer',
                    deliveryDate: '30 Juni 2025',
                    deliveryTime: '12:00 WIB',
                    deliveryAddress: 'Jl. Pahlawan No. 123, Kota Pahlawan, 60285',
                    notes: 'Tolong sambalnya dipisah.',
                    items: [
                        { id: 1, name: 'Paket Nasi Ayam Bakar', quantity: 20, price: 25000 },
                        { id: 2, name: 'Paket Nasi Ikan Goreng', quantity: 15, price: 22000 },
                        { id: 3, name: 'Air Mineral Botol', quantity: 35, price: 3000 }
                    ]
                },
                ...
                cancelOrder() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            // Jika pengguna mengklik "Ya, batalkan!"
                            Swal.fire(
                                'Dibatalkan!',
                                'Pesanan Anda telah berhasil dibatalkan.',
                                'success'
                            )
                            // Di sini Anda bisa menambahkan logic untuk mengirim request ke server
                        }
                    })
                },
            }
