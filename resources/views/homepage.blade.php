<x-layout>
    ...
    <section class="text-center px-5 pt-16 lg:pb-16 pb-10 max-w-6xl mx-auto">
        <h1 class="text-5xl font-bold mb-5 md:text-5xl">Solusi Catering Lezat,<br>Cepat & Praktis!</h1>
        ...
        <div class="flex gap-5 justify-center mb-12 md:flex-row flex-col items-center">
            <a href="{{ route('login') }}" class="px-6 py-2 rounded-md font-semibold bg-[#FFA900] text-white border border-[#FFA900] hover:opacity-90 hover:-translate-y-0.5 transition-all duration-300">Pesan Sekarang!</a>
            <a href="{{ route('register') }}" class="px-6 py-2 rounded-md font-semibold border border-[#FFA900] text-[#FFA900] hover:opacity-90 hover:-translate-y-0.5 transition-all duration-300">Buat Akun</a>
        </div>
    ...
    <section class="text-center px-5 py-20 bg-gray-50">
        ...
        <p class="mb-12 text-lg lg:mb-8 max-w-2xl mx-auto">Layanan Catering Terbaik yang Sesuai dengan Kebutuhan Anda, Mulai Sekarang dengan Daftar atau Masuk!</p>
        <a href="{{ route('register') }}" class="px-6 py-2 rounded-md font-semibold bg-[#FFA900] text-white border border-[#FFA900] hover:opacity-90 hover:-translate-y-0.5 transition-all duration-300">Daftar sekarang!</a>
    </section>
